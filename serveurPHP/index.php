...
<body>
    <form action="index.php" method="POST">
        ...
        <input class="radioBtn" type="radio" value="small" name="calibre" >small<br>
        <input class="radioBtn" type="radio" value="medium" name="calibre">medium<br>
        <input class="radioBtn" type="radio" value="large" name="calibre">large <br>
    ...
    <table class="table table-hover table-responsive">
        ...
        ?>
        <tr>
            <td><?php echo "CONSOMMATION ELECTRICITE: <br>".$value ; ?></td>
            <td><?php echo "TARIFS: <br>".$tarifs[$key]->tarif ; ?></td>
            <td><?php echo "Montant HT: <br>".$montantsHT[$key] ; ?></td>
            <td><?php echo "Taux TVA <br>".$tva . "%"; ?></td>
            <td><?php echo "Montant Taxes <br>".$montantsHT[$key] * $tva /100 ; ?></td>
        ...
        ?>
        <tr>
            <td><?php echo "REDEVANCE FIXE ELECTRICITE <br>".$redevance[$calibre];?></td>
        </tr>
    </table>
</body>
</html>